...
public class LetterCandles {
    ...
    // there is a box with N letter candles. The cost is determined as following:
    // number of occurrences of each characters in the box and sum up the squares of these numbers
    // we want to reduce the cost of the box by removing some candles from the box
    //help to find the minimum cost of the box
